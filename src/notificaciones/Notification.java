...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notificaciones/sucess.png")));
            lbMessage.setText("EXITO");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notificaciones/info.png")));
            lbMessage.setText("AVISO");
        } else if(type == Type.WARNING){
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notificaciones/warning.png")));
            lbMessage.setText("ADVERTENCIA");
        }else if(type == Type.ERROR){
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notificaciones/error.png")));
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notificaciones/sucess.png"))); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notificaciones/close.png"))); // NOI18N
